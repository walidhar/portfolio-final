                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="" method="POST" enctype="multipart/form-data">
                                    ...
                                    <input type="submit" name="submiting" class="btn btn-primary" value="add project">
                                </form>
                                <?php
                                if(isset($_POST['submiting'])){
                                    ...
                                    $addt = new PDO("mysql:host=localhost;dbname=portfolio","root","");
                                    $rept = "INSERT INTO `work` (`id`, `image`, `nomprojet`, `lien`, `source`) VALUES (NULL, '$nomimg', '$nompro', '$lienpro','github')";
                                    $addt->query($rept);
                                    echo "le projet $nompro a ajouter";
                                }
                                ?>
                            </div>
                        </div>
                            ...
                            <div class="card-header">
                                ...
                                <?php   
                                  if(isset($_POST['supremer'])){
                                   $del ="DELETE FROM work WHERE id = $c";
                                  $add->query($del);
                                  echo "le projet a supprimer";
                                }
                                ?>
